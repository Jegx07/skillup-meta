        ...
        <Card className="glass glow-hover border-primary/20">
          ...
          <CardContent>
            ...
            <div className="grid grid-cols-2 gap-4">
              <Button
                variant="outline"
                className="glass glass-hover h-12 border-2 border-pink-400 hover:border-primary/80 hover:bg-pink-50 text-pink-700 font-semibold flex items-center justify-center"
              ...
              <Button
                variant="outline"
                className="glass glass-hover h-12 border-2 border-blue-500 hover:border-primary/80 hover:bg-blue-50 text-blue-700 font-semibold flex items-center justify-center"
